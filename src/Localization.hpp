...
public:
    Localization() : currentLang(Language::ENG) {
        ...
        translations["load"] = {{Language::ENG, "Load Image"}, {Language::RU, "Загрузить"}};
        translations["save"] = {{Language::ENG, "Save Image"}, {Language::RU, "Сохранить"}};
        translations["clear"] = {{Language::ENG, "Clear Canvas"}, {Language::RU, "Очистить"}};
        ...
        translations["apply_size"] = {{Language::ENG, "Apply Size"}, {Language::RU, "Применить"}};
